            ...
            <View className="items-center">
              ...
              <View className="items-center mb-6">
                <Text className="text-2xl font-semibold text-foreground text-center mb-2">
                  {t('common.permissions.notifications.title', 'Enable Prayer Notifications')}
                </Text>
              ...
              <View className="w-full gap-3">
                <Button onPress={handleRequestPermission} className="w-full">
                  <Text className="text-primary-foreground font-semibold">
                    {t('common.permissions.notifications.allow', 'Allow Notifications')}
                  </Text>
                </Button>
                <Button variant="outline" onPress={handleOpenSettings} className="w-full">
                  <Text className="font-medium">
                    {t('common.permissions.notifications.settings', 'Open Settings')}
                  </Text>
                </Button>
              </View>
            </View>
