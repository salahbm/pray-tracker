        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-3 md:grid-cols-4">
          {topGrid.map((c) => (
            <div key={c.key} className="group flex flex-col items-center justify-center gap-4 py-1 md:px-5 md:py-3">
              ...
              <span className="text-body-2 tracking-tight">{t(`categories.${c.key}`)}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        {expanded && (
          ...
          >
            <div className="mt-8 text-center">
              <div className="text-body-2 px-2.5 py-1.5">{t("sections.features")}</div>
            ...
            <div className="mt-8 text-center">
              <div className="text-body-2 px-2.5 py-1.5">{t("sections.industries")}</div>
              <div className="mt-2 flex flex-wrap justify-center gap-2">
                {industries.map((i) => (
                  <p
                    key={i}
