...
export const AboutSection: React.FC<{
  ...
  return (
    ...
    >
      {header && <h1 className="text-subtitle mb-20">{header}</h1>}
      <OverlapCircles text={number} overlapText={overlapText} />
      <h1 className="text-subtitle mt-15 md:mt-25 lg:mt-20">{title}</h1>
      <p className="text-body-2 mt-6 lg:mt-10">{subtitle}</p>
    </section>
  )
}
