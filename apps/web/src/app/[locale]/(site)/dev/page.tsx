...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "https://noorapp.uz",
    images: [
      {
        width: 1200,
        height: 630,
        url: "https://raw.githubusercontent.com/noor/noor-web/main/.github/assets/project-logo.png",
      },
    ],
  },
}
    ...
    <>
      <section className="bg-white">
        <div className="max-w-(--breakpoint-xl) mx-auto grid px-4 py-8 text-center lg:py-16">
          <div className="mx-auto place-self-center">
            ...
            <h2 className="mb-4 max-w-2xl text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">
              {t("title")}
            </h2>
          </div>
        </div>
        ...
        <div className="items-center justify-center space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          {colors.map((color) => (
            <div
              key={color.name}
              className={cn(
                "min-w-sm flex w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center",
                color.value,
      ...
      <section className="my-12 flex flex-col items-center justify-center bg-white">
        ...
        <div className="items-center justify-center space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          ...
          <h2 className="typo-title-1">Title 1</h2>
          <h2 className="typo-title-1">Title 1 KR</h2>
          <h2 className="typo-title-2">Title 2</h2>
          <h2 className="text-title-3">Title 3</h2>
          <h2 className="typo-subtitle">Subtitle</h2>
          <h2 className="typo-body-1">Body 1</h2>
          <h2 className="typo-body-2">Body 2</h2>
          <h2 className="typo-caption">Caption</h2>
        </div>
      </section>
      {/* SHADOWS BLOCK */}
      <section className="my-12 flex flex-col items-center justify-center bg-white">
        ...
        <div className="items-center justify-center space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          <div className="shadow-1 min-w-sm flex w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center">
            <h3 className="mb-2 text-xl font-bold">Shadow 1</h3>
            <p className="text-gray-700">Shadow 1</p>
          </div>
          <div className="shadow-2 min-w-sm flex w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center">
      ...
      <section className="my-12 flex flex-col items-center justify-center bg-white">
        ...
        {/* XS */}
        <div className="min-w-sm flex w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center sm:hidden">
          <h3 className="text-xl font-bold">This card will appear on xs</h3>
        </div>
        {/* SM */}
        <div className="min-w-sm hidden w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center sm:flex md:hidden">
          <h3 className="text-xl font-bold">This card will appear on mobile</h3>
        </div>

        {/* Tablet */}
        <div className="min-w-sm hidden w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center md:flex lg:hidden">
          <h3 className="text-xl font-bold">This card will appear on tablet</h3>
        </div>

        {/* Desktop */}
        <div className="min-w-sm hidden w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center lg:flex xl:hidden">
          <h3 className="text-xl font-bold">This card will appear on desktop</h3>
        </div>

        {/* Desktop XL */}
        <div className="min-w-sm hidden w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center xl:flex 2xl:hidden">
          <h3 className="text-xl font-bold">This card will appear on desktop-xl</h3>
        </div>
        {/* Desktop 2XL */}
        <div className="min-w-sm hidden w-fit flex-col rounded-lg border border-gray-400 p-4 px-12 text-center 2xl:flex">
      ...
      <section className="bg-white">
        <div className="max-w-(--breakpoint-xl) mx-auto px-4 py-8 sm:py-16 lg:px-6">
