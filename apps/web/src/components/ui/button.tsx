  ...
  "text-body-1 flex cursor-pointer items-center justify-center gap-2 transition-all duration-300 ease-in-out",
  {
    variants: {
      variant: {
        ...
        send: "text-title-2 gap-3 min-h-[280px] min-w-[280px] size-[280px] aspect-square rounded-full text-white bg-black/70 hover:bg-black hover:[&>svg]:translate-x-2 [&>svg]:transition-all [&>svg]:duration-300 [&>svg]:ease-in-out",
        chip: "px-2.5 min-w-40 py-2 border border-black rounded-xl bg-transparent hover:text-white hover:bg-black/70 disabled:border-[0.5px] disabled:bg-transparent disabled:text-gray-500 disabled:border-gray-500 disabled:text-body-2 data-[selected=true]:bg-black data-[selected=true]:text-white",
        file: "px-5 py-2 min-w-28 text-body-2 text-black border border-black hover:bg-black/70 hover:text-white hover:border-none rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
