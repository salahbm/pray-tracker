    ...
    <section className="bg-primary-100 w-full">
      ...
      >
        ...
        <div className="flex flex-col gap-6 text-white md:flex-1">
          <h3 className="typo-title-2">Be our partner, make success.</h3>

          <div className="typo-body-1 hidden flex-col gap-4 md:flex md:flex-row md:gap-6">
        ...
        <Link
          href="/request"
          className="typo-title-2 inline-flex items-center gap-5 text-white md:justify-end"
          data-cursor-yellow
        >
        ...
        <div className="typo-body-1 flex flex-col gap-4 text-white md:hidden md:flex-row md:gap-6">
          <a href={appConfig.app.company_profile} target="_blank" className="flex items-center gap-3">
            <DownloadIcon />
            Co. Brief
          </a>
