...
export const ERROR_MESSAGES: ErrorMessages = {
  ...
  INVALID_TOKEN: {
    ...
    id: 'Token tidak sah atau kedaluwarsa',
    ms: 'Token tidak sah atau luput',
  ...
  INVALID_EMAIL: {
    ...
    id: 'Format email tidak sah',
    ms: 'Format emel tidak sah',
  ...
  USER_ALREADY_EXISTS_USE_ANOTHER_EMAIL: {
    ...
    id: 'Pengguna sudah ada. Gunakan email lain',
    ms: 'Pengguna sudah wujud. Gunakan emel lain',
  ...
  FRIEND_REQUEST_SENT: {
    ...
    id: 'Permintaan pertemanan berhasil dikirim',
    ms: 'Permintaan rakan berjaya dihantar',
  ...
  FRIEND_REMOVED: {
    ...
    id: 'Teman berhasil dihapus',
    ms: 'Rakan berjaya dibuang',
  ...
  FRIEND_REQUEST_ALREADY_EXISTS: {
    ...
    id: 'Permintaan pertemanan sudah ada',
    ms: 'Permintaan rakan sudah wujud',
  ...
  FRIEND_REQUEST_NOT_FOUND: {
    ...
    id: 'Permintaan pertemanan tidak ditemukan',
    ms: 'Permintaan rakan tidak ditemui',
  ...
  CANNOT_SEND_REQUEST_TO_SELF: {
    ...
    id: 'Tidak bisa mengirim permintaan ke diri sendiri',
    ms: 'Tidak boleh hantar permintaan kepada diri sendiri',
  ...
  FRIEND_NOT_FOUND: {
    ...
    uz: "Do'st topilmadi",
    ru: 'Друг не найден',
    id: 'Teman tidak ditemukan',
    ms: 'Rakan tidak ditemui',
  ...
  GROUP_CREATED: {
    ...
    id: 'Grup berhasil dibuat',
    ms: 'Kumpulan berjaya dibuat',
  ...
  GROUP_UPDATED: {
    ...
    id: 'Grup berhasil diperbarui',
    ms: 'Kumpulan berjaya dikemaskini',
  ...
  GROUP_DELETED: {
    ...
    id: 'Grup berhasil dihapus',
    ms: 'Kumpulan berjaya dipadam',
  ...
  MEMBER_ADDED: {
    ...
    id: 'Anggota berhasil ditambahkan ke grup',
    ms: 'Ahli berjaya ditambah ke kumpulan',
  ...
  MEMBER_REMOVED: {
    ...
    id: 'Anggota berhasil dihapus dari grup',
    ms: 'Ahli berjaya dibuang dari kumpulan',
  ...
  ONLY_FRIENDS_CAN_BE_ADDED: {
    ...
    id: 'Hanya teman yang bisa ditambahkan ke grup',
    ms: 'Hanya rakan boleh ditambah ke kumpulan',
  ...
  ALREADY_GROUP_MEMBER: {
    ...
    id: 'Pengguna sudah menjadi anggota grup ini',
    ms: 'Pengguna sudah menjadi ahli kumpulan ini',
